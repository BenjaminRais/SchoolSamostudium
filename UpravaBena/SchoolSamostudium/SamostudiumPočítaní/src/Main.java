...
public class Main {
	...
	public static void main(String[] args) {
		...
		//Nedostateèný popisek!! Nevíme co bude program poèítat, jestli obvod obsah nebo neco jiného.
		//Leda bys musel celý program pøeèíst a dle výpoètu to zijstit.
		...
		case 1:
			...
			//Vytoøil bych tøídu, ve které bych vytvoøil pro každý geometrický útvar jednu metodu na výpoèet konkrétní neznámé
		...
		case 2:
			...
			//Vytoøil bych metodu, kterou bych zde jen použil.
		...
		case 3:
			...
			break;
			//Celou metodu main bys mìl mít v Try - Catch, abys ošetøil alespoò nìjaké chyby.
		}
